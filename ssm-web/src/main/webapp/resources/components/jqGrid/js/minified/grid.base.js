/**
 *
 * @license Guriddo jqGrid JS - v5.0.2
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        template: function (a) {
            ...
            return null == a && (a = ""), a.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function (a, e) {
                ...
                for (b = 0; d > b; b++)if ($.isArray(c[b]))for (var f = c[b],
                                                                    g = f.length; g--;)if (e === f[g].nm)return f[g].v
            })
        },
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                    ...
                    if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                        ...
                        if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                            e && (T *= e + 1);
                            var W, X = $.isFunction(d.p.afterInsertRow), Y = !1,
                    ...
                    if (a) {
                        ...
                        var Y, Z = $.isFunction(d.p.afterInsertRow), _ = [], aa = !1,
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        var w = r.select(), x = parseInt(d.p.rowNum, 10), y = w.length, z = parseInt(d.p.page, 10),
                            A = Math.ceil(y / x), B = {};
                    ...
                    for (var i = 0,
                             j = s.length; j > i; i++)i > 0 && (d.p.sortname += ", "), d.p.sortname += s[i], i !== j - 1 && (d.p.sortname += " " + t[i]);
                    d.p.sortorder = t[j - 1]
                ...
                var sa = $("tr:first", ja), ta = "<tr class='jqgfirstrow' role='row'>";
                ...
                var va = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ja),
                    wa = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1,
                    xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
                ja = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(xa), $(xa).append(va), va = null, wa && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v), wa && $(d.p.pager).hide(), T(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    var b = $(fa).hasClass("cbox"), c = $(d).triggerHandler("jqGridBeforeSelectRow", [ga[0].id, a]);
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var e = d.p.beforeSelectRow.call(d, ga[0].id, a);
                        (e === !1 || "stop" === e) && (c = !1)
                    }
                    if ("A" !== fa.tagName && ("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName || b))if (ya = ga[0].id, fa = $(fa).closest("tr.jqgrow>td"), fa.length > 0 && (za = $.jgrid.getCellIndex(fa), Aa = $(fa).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [ya, za, Aa, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ya, za, Aa, a)), d.p.cellEdit !== !0) {
                        if (c)if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", ya, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b)); else if (d.p.multiselect && d.p.multiboxonly)if (b) $(d).jqGrid("setSelection", ya, !0, a); else {
                    ...
                    } else if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", ya, !0, a); else if (fa.length > 0)try {
                ...
                var Ba = q + " " + k(l, "icon_caption_open", !0), Ca = q + " " + k(l, "icon_caption_close", !0);
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
                    ...
                    var Ga = "onorientationchange" in window, Ha = Ga ? "orientationchange" : "resize";
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                ...
                if (b.grid) {
                    ...
                    b.p.footerrow && a && $(".ui-jqgrid-ftable td", b.grid.sDiv).html("&#160;"), b.p.selrow = null, b.p.selarrrow = [],
                        b.p.savedRow = [], b.p.records = 0, b.p.page = 1, b.p.lastpage = 0, b.p.reccount = 0, b.p.data = [], b.p._index = {}, b.updatepager(!0, !1)
                }
            })
        }, getInd: function (a, b) {
            var c, d = !1;
