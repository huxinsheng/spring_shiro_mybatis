...
!function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
                    ...
                    if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                        if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) U(b, f); else {
                            ...
                            var g, h = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null,
                                i = d.p.frozenColumns ? f : d.grid.headers[b].el, j = "single" === d.p.viewsortcols[1];
        ...
        getGridParam: function (a, b) {
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
                ...
                var y, z = 0,
                    ...
                    B = {}, C = !!$.isFunction(w.p.afterInsertRow);
                ...
                if (d.grid && d.p.cellEdit === !0) {
                    if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
                        var g, h, i = $("td:eq(" + b + ")", d.rows[a]), j = d.p.colModel[b], k = j.name,
                            l = $.jgrid.jqID(k), m = $(i).offset();
                        switch (j.edittype) {
                            case"select":
                                if (j.editoptions.multiple) {
                                    var n = $("#" + a + "_" + l, d.rows[a]), o = [];
                            ...
                            case"custom":
                                try {
                                    ...
                                    "e1" === q ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.nodefined, f.bClose, {styleUI: d.p.styleUI}) : "e2" === q ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.novalue, f.bClose, {styleUI: d.p.styleUI}) : $.jgrid.info_dialog(e.errcap, q.message, f.bClose, {styleUI: d.p.styleUI})
                                }
                        }
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            var t = $.jgrid.checkValues.call(d, g, b), u = !1;
                            if (t[0] === !0) {
                                var v = $(d).triggerHandler("jqGridBeforeSubmitCell", [d.rows[a].id, k, g, a, b]) || {};
                                if ($.isFunction(d.p.beforeSubmitCell) && (v = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), v || (v = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)if (d.p.cellurl) {
                                    var w = {};
                                    ...
                                    z = d.p.prmNames, x = z.id, y = z.oper, w[x] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), w[y] = z.editoper, w = $.extend(v, w), $(d).jqGrid("progressBar", {
                                        ...
                                        error: function (c, g, h) {
                                            $("#lui_" + $.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = !1, $(d).triggerHandler("jqGridErrorCell", [c, g, h]), $.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, c, g, h) : $.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {styleUI: d.p.styleUI}), d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b)
                                        }
                                    }, $.jgrid.ajaxOptions, d.p.ajaxCellOptions || {}))
                                } else try {
                                    $.jgrid.info_dialog(e.errcap, e.nourl, f.bClose, {styleUI: d.p.styleUI}), d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b)
                                } catch (q) {
                                }
        ...
        showModal: function (a) {
            ...
            if (b = $.extend({
                    ...
                    jqm: !0,
                    jqM: !0
                }, b || {}), void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && b.jqm === !0) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow(); else if ("" !== b.gbox && ($(".jqgrid-overlay:first", b.gbox).show(), $(a).data("gbox", b.gbox)), $(a).show().attr("aria-hidden", "false"), b.focusField >= 0)try {
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, j = function () {
                            ...
                            for (var f, i, k = $(".ui-jqgrid-view").css("font-size") || "11px",
                                     l = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + k + ";left:" + d + "px;top:" + e + 'px;">',
                                     m = $(b).attr("soper"), n = [], o = 0, p = $(b).attr("colname"),
                                     q = c.p.colModel.length; q > o && c.p.colModel[o].name !== p;)o++;
                ...
                return b = $.extend(!0, {
                    ...
                    function d(a, b, c, d) {
                        var f, g, h, i, j, k, l, m = 0, n = [], o = !1,
                            p = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", r = "";
                        for (l = 1; d >= l; l++)r += p;
                                ...
                                switch (q.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = e), d = $.jgrid.jqID(d), k[f].edittype) {
                                    ...
                                    case"custom":
                                        try {
                                            ...
                                            "e1" === l ? $.jgrid.info_dialog(E.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.nodefined, $.rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI}) : $.jgrid.info_dialog(E.errcap, l.message, $.rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI})
                                        }
                                }
                                j++
                            }
                    ...
                    function i() {
                        ...
                        for (e in s)if (s.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(q, s[e], e), l[0] === !1))break;
                            ...
                            var t = $.extend({
                                ...
                                complete: function (e, h) {
                                    ...
                                    if ($("#sData", y + "_2").removeClass(f.active), s[c] = q.p.idPrefix + s[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [e, u]), $.isFunction(rp_ge[q.p.id].errorTextFormat) ? l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u) : l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [e, s, u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))), l[0] === !1) $(".FormError", w).html(l[1]), $(".FormError", w).show(); else if (q.p.autoencode && $.each(s, function (a, b) {
                                        ...
                                        }, 500)), (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && ($(w).data("disabled", !1), "_empty" !== rp_ge[q.p.id]._savedData[q.p.id + "_id"]))for (j in rp_ge[q.p.id]._savedData)rp_ge[q.p.id]._savedData.hasOwnProperty(j) && s[j] && (rp_ge[q.p.id]._savedData[j] = s[j]);
                    ...
                    function n() {
                        var a = $(q).jqGrid("getDataIDs"), b = $("#id_g", y).val(), c = $.inArray(b, a);
                        return [c, a]
                    }
                    ...
                    var q = this;
                    if (q.grid && a) {
                        var r, s, t, u, v = q.p.id, w = "FrmGrid_" + v, x = "TblGrid_" + v, y = "#" + $.jgrid.jqID(x),
                            z = {
                                themodal: "editmod" + v,
                                modalhead: "edithd" + v,
                ...
                return b = $.extend(!0, {
                    ...
                    if (j.grid && a) {
                        ...
                        if ($(j.p.colModel).each(function () {
                            ...
                            d(a, j, x, s);
                            var y = "rtl" === j.p.direction, z = y ? "nData" : "pData", A = y ? "pData" : "nData",
                ...
                return b = $.extend(!0, {
                    ...
                    if (c.grid && a) {
                        var d, g, h, i, j = $.isFunction(rp_ge[c.p.id].beforeShowForm),
                            ...
                            m = c.p.id, n = {}, o = !0, p = "DelTbl_" + $.jgrid.jqID(m), q = "DelTbl_" + m, r = {
                                themodal: "delmod" + m,
                                modalhead: "delhd" + m,
                                ...
                                if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
                                    ...
                                    var k = $.extend({
                                        ...
                                        complete: function (a, g) {
                                            var h;
                                            if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, $.isFunction(rp_ge[c.p.id].errorTextFormat) ? e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a) : e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1) $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show(); else {
                ...
                if (c = $.extend({
                    ...
                    if (b) {
                        ...
                        if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
                            ...
                            var m = $("#" + a).jqGrid(d);
                            if (m.append(f), m.jqGrid("setGridParam", l), d.storeNavOptions && d.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.navButtons && d.navButtons.length))for (var n = 0; n < d.navButtons.length; n++)"sepclass" in d.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", d.navButtons[n][0], d.navButtons[n][1]) : m.jqGrid("navButtonAdd", d.navButtons[n][0], d.navButtons[n][1]);
                            d.inlineNav && g && (m.jqGrid("setGridParam", {inlineNav: !1}), m.jqGrid("inlineNav", d.pager, g)), d.filterToolbar && h && (m.jqGrid("setGridParam", {filterToolbar: !1}), h.restoreFromFilters = !0, m.jqGrid("filterToolbar", h)), d.frozenColumns && m.jqGrid("setFrozenColumns"), m[0].updatepager(!0, !0), $.isFunction(c.afterSetGrid) && c.afterSetGrid(m), c.clearAfterLoad && (window[c.storageType].removeItem("jqGrid" + i.id), window[c.storageType].removeItem("jqGrid" + i.id + "_data"))
                        ...
                        if ("object" != typeof a[e]) {
                            if ("level" === e) {
                                if (void 0 === J[a.level] && (J[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (i[a.level - 1] = {
                                    ...
                                    var h = i[a.level - 1].groupHeaders.length - 1, k = 0 === h ? L : K;
        ...
        setTreeNode: function (a, b) {
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid)for (var d, e, f, g, h, i, j, k, l = c.p.expColInd,
                                                    m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field,
                                                    o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field,
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid)switch (c.p.treeGridModel) {
                    case"nested":
                        ...
                        break;
                    case"adjacency":
                        for (var j = c.p.treeReader.parent_id_field, k = c.p.localReader.id, l = a[k],
                                 m = c.p._index[l]; m--;)if (c.p.data[m][k] === $.jgrid.stripPref(c.p.idPrefix, a[j])) {
                            b = c.p.data[m];
                            break
                        }
                }
    ...
    $.fn.tinyDraggable = function (a) {
        ...
        return this.each(function () {
            var a, c, d = $(this), e = b.handle ? $(b.handle, d) : d;
            e.on({
    ...
    $.fmatter = {}, $.extend($.fmatter, {
        ...
        if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
            var g, h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === !0) == !0, i = [];
        ...
        if (g.value) {
            var j, k = g.value, l = g.multiple === !0, m = [];
